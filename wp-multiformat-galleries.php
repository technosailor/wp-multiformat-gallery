 ...
 *
 * Extends the core WordPress galleries and allows custom templates and formats
 */
class WP_Multiformat_Galleries {
	...
	/**
	 * Enqueue our necessary Javascript assets
	 */
	public function js() {
	...
	/**
	 * @param $output The HTML that is generated by WordPress to render core galleries. Note: You shouldn't even look at that. Write your own markup here
	 * @param $attributes an array of information about the gallery including, importantly, post IDs for the associated images
	 * @param $instance I dunno ¯\_(ツ)_/¯
	 *
	 * @return mixed|string|void the fully rendered HTML for the gallery inclusing appropriate wrapper tags
	 */
	 ...
	 * @param $caption
	 *
	 * @return mixed|void The fully rendered HTML for ONE image
	 */
